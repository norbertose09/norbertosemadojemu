...
<body data-spy="scroll" data-target="#pb-navbar" data-offset="200">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample09">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="#section-portfolio">My Works</a></li>
	...
	<section class="site-hero" style="background-image: url(images/jefferson-santos-9SoCnyQmkzI-unsplash.jpg);" id="section-home" data-stellar-background-ratio="0.5">
		<div class="container">
			<div class="row intro-text align-items-center justify-content-center">
				<div class="col-md-10 text-center pt-5">

					<h1 class="site-heading site-animate"><strong class="d-block">Norbert Madojemu</strong>Software Developer </h1>
		...
		<div class="container">
			<div class="row mb-5 align-items-center">
				<div class="col-lg-7 pr-lg-5 mb-5 mb-lg-0">
					<img src="images/photo_2022-08-22_16-57-34.jpg" alt="Image placeholder" class="img-fluid">
				</div>
				<div class="col-lg-5 pl-lg-5">
					<div class="section-heading">
						<h2>About <strong>Me</strong></h2>
					</div>
					<p class="lead">I am a back-end developer with a bachelor's degree in CS(computer sceince)</p>
					<p class="mb-5  ">As a backend developer with over two years of experience, it has been my role to participate in the design and creation of scalable software, building and maintaining web applications, writing clean and high quality code, performing QA testing, keeping on top of new technologies, troubleshooting and debugging. I have the necessary skills to handle complex back-end related task.</p>

					<p>
						<a href="#section-contact" class="btn btn-primary px-4 py-2 btn-sm smoothscroll">Hire Me</a>
						<a href="resume.docx" class="btn btn-secondary px-4 py-2 btn-sm">Download CV</a>
					</p>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-7 mb-5 mb-md-0">
					<form action="mailconfig.php" class="site-form" method="post">
						...
						<div class="form-group">
							<input type="number" class="form-control px-3 py-4" placeholder="Your Phone" name="phone">
						</div>
						<div class="form-group mb-5">
							<textarea class="form-control px-3 py-4"cols="30" rows="10" placeholder="Write a Message" name="text"></textarea>
						</div>
						<div class="form-group">
							<input type="submit" class="btn btn-primary  px-4 py-3" value="Send Message" name="submit">
						</div>
					</form>
				</div>
				<div class="col-md-5 pl-md-5">
					...
					<ul class="site-contact-details">
						...
						<li>
							<span class="text-uppercase">WhatsAppFax</span>
							+2347017362374
						</li>
		...
		<div class="container">
			...
			<div class="row mb-5">
				<p class="col-12 text-center">
					...
					Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved | Norbert Madojemu.</a>
				</p>
			</div>
